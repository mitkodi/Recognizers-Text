    ...
    public class OrdinalExtractor : BaseNumberExtractor
    {
            ...
            : base(options)
        {
            ...
            var regexes = new Dictionary<Regex, TypeTag>
            {
                ...
                {
                    new Regex(NumbersDefinitions.OrdinalBulgarianRegex, RegexOptions.Singleline),
                    RegexTagGenerator.GenerateRegexTag(Constants.ORDINAL_PREFIX, Constants.BULGARIAN)
                },
                {
